...
from data_manager import nome_squadra, get_squadra_by_id, compute_overall, BYE_ID
...
def render_player_card_html(atleta, photo_url=None):
    """
    Genera HTML della carta FC26. Se photo_url manca usa placeholder SVG.
    Overall in alto a sinistra con glow, badge sotto (trofei, vittorie).
    """
